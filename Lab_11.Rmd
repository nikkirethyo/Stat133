...
*The exchange rate for GBP on 4/8 was 0.8073 and the exchange rate for GBP on 4/7 was 0.80728* 
...
Yes, the 6th & 7th element of this vector are the values for the dates 4/8 and 4/7 which match what was previously found. 


*How many dates are there?*

There are 63 dates, because each value in the vector of rates is associated with a particular day and the length of gbp1 is 63. 
...
all Cube nodes with a time attribute. Remember to use 
...
![]( /Users/Adam/Desktop/stat133lectures_hw_lab/labs/lab11/lab11pic.png)
